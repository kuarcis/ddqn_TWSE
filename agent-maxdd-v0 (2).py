    ...
    try:
        ...
        while True:
            ...
            if pack_s[2] or (not pack_s[2] and random.randint(0,1000)<300):
                ...
                # false postive define as: maxdd didnt happened, but pred_a != 0
                ...
                if game_agent.memory.len() >55 and step_count % 600 == 1:
                    ...
                    if alt_training == False:
                        if step_count < 75000 or critic_loss > 0.06: 
                ...
                if step_count % 1800 == 0:
                    ...
                    if len(set_avg_r) != 0:
                        print('average set reward in recent 10 set:',format(sum(set_avg_r)/len(set_avg_r),'.2f'))
                    if IsTriained:
